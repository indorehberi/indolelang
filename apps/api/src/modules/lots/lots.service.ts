    ...
    const lots = records.map((l: any) => {
      ...
      return {
        ...
        asset: {
          ...
          bpkb_number: l.asset.bpkb_number || undefined,
          frame_number: l.asset.frame_number || undefined,
          stnk_date: l.asset.stnk_date ? l.asset.stnk_date.toISOString() : undefined,
          stnk_tax_date: l.asset.stnk_tax_date ? l.asset.stnk_tax_date.toISOString() : undefined,
          keur_date: l.asset.keur_date ? l.asset.keur_date.toISOString() : undefined,
