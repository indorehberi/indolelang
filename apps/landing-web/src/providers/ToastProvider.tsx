...
export function ToastProvider({ children }: { children: React.ReactNode }) {
  ...
  // Memoised so `useToast()` returns a stable reference. Rebuilding this
  // object every render makes it unusable in a hook dependency array — an
  // effect listing `toast` would re-run on every unrelated state change (the
  // provider intake form was re-checking /providers/me on each keystroke).
