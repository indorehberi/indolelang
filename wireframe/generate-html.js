        ...
        specificContent = `
          <div class="grid-2-1">
            <div class="card" style="padding:0; overflow:hidden;">
              <div class="img-placeholder" style="height:360px; background:#000; color:#fff; flex-direction:column; position:relative;">
                <div style="position:absolute; top:1rem; left:1rem;"><span class="badge badge-danger">LIVE STREAM</span></div>
                <div style="font-size:3rem;">🎥</div>
                <div class="fs-sm">Streaming Juru Lelang (WebRTC)</div>
              </div>
              <div style="padding: 1rem;">
                <h3 class="fw-bold" style="font-size:1.1rem;">Toyota Avanza 1.3 G MT 2022</h3>
                <p class="text-muted fs-sm">Lot #1045 • Sesi Jakarta • Grade B</p>
              </div>
            </div>
            <div class="bidding-panel">
              <div class="fs-sm text-uppercase" style="color: rgba(255,255,255,0.7);">Harga Penawaran Tertinggi</div>
