...
export const ErrorCode = {
  ...
  // Delete User Safe-guard Errors
  PENDING_DEPOSIT_APPROVAL: 'PENDING_DEPOSIT_APPROVAL',
  ACTIVE_NIPL_EXISTS: 'ACTIVE_NIPL_EXISTS',
  UNPAID_INVOICE_EXISTS: 'UNPAID_INVOICE_EXISTS',
